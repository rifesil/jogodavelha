...
public class TicTacToeService {
	...
	public ResponseDTO hasWon(RequestDTO jogoRequest) {
		...
		return new ResponseDTO(true, map.get(true));
	...
	public boolean isVelha(int[] jogo) {
		...
		if (matriz[0][0] == matriz[0][1] && matriz[0][0] == matriz[0][2]) {
			...
			map.put(true, "Ganhou | " + Player.valueOf(matriz[0][0]).name() + " | Horizontal linha 1");
			return true;
		} else if (matriz[1][0] == matriz[1][1] && matriz[1][0] == matriz[1][2]) {
			log.info("Horizontal linha 2");
			map.put(true, "Ganhou | " + Player.valueOf(matriz[1][0]).name() + " | Horizontal linha 2");
			return true;
		} else if (matriz[2][0] == matriz[2][1] && matriz[2][0] == matriz[2][2]) {
			log.info("Horizontal linha 3");
			map.put(true, "Ganhou | " + Player.valueOf(matriz[2][0]).name() + " | Horizontal linha 3");
			return true;
		} else if (matriz[0][0] == matriz[1][0] && matriz[0][0] == matriz[2][0]) {
			log.info("Vertical coluna 1");
			map.put(true, "Ganhou | " + Player.valueOf(matriz[0][0]).name() + " | Vertical coluna 1");
			return true;
		} else if (matriz[0][1] == matriz[1][1] && matriz[0][1] == matriz[2][1]) {
			log.info("Vertical coluna 2");
			map.put(true, "Ganhou | " + Player.valueOf(matriz[0][1]).name() + " | Vertical coluna 2");
			return true;
		} else if (matriz[0][2] == matriz[1][2] && matriz[0][2] == matriz[2][2]) {
			log.info("Vertical coluna 3");
			map.put(true, "Ganhou | " + Player.valueOf(matriz[0][2]).name() + " | Vertical coluna 3");
			return true;
		} else if (matriz[0][0] == matriz[1][1] && matriz[0][0] == matriz[2][2]) {
			log.info("Diagonal para Esquerda");
			map.put(true, "Ganhou | " + Player.valueOf(matriz[0][0]).name() + " | Diagonal para Esquerda");
			return true;
		} else if (matriz[0][2] == matriz[1][1] && matriz[0][2] == matriz[2][0]) {
			log.info("Diagonal para Direita");
			map.put(true, "Ganhou | " + Player.valueOf(matriz[0][2]).name() + " | Diagonal para Direita");
			return true;
		} else {
